...
const Testimonials: React.FC = ({ onOpenModal }) => {
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-cyan-500/10 to-purple-500/10 backdrop-blur-xl border border-cyan-500/20 rounded-3xl p-6">
              ...
              <button onClick={onOpenModal} className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500 text-white px-4 py-3 rounded-2xl font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2">
