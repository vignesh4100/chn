...
const Services: React.FC = ({ onOpenModal }) => {
  ...
  const services = [
    {
      ...
      page: '/technology/infrastructure',
    ...
    <section className="py-20 bg-gradient-to-b from-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-20">
          ...
          <div className="w-32 h-1 bg-gradient-to-r from-blue-500 to-blue-700 mx-auto mt-8 rounded-full"></div>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative p-8">
                ...
                {/* CTA Button */}
                <Link to={service.page} className={`w-full bg-gradient-to-r ${service.color} hover:opacity-90 text-white px-6 py-4 rounded-2xl font-semibold transition-all duration-300 flex items-center justify-center gap-2 group-hover:shadow-2xl transform group-hover:scale-105`}>
