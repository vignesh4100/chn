        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            ...
            <div className="hidden sm:block">
              <span className={`text-xl font-bold ${isScrolled ? 'text-gray-800' : 'text-white'} block `}>CHN Technologies</span>
...
>
  ...
  <ChevronDown className="w-4 h-4 transition-transform group-hover/menu:rotate-180" />
          ...
          <div className="hidden lg:flex items-center">
            <Link
              to="/contact"
              className="bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-400 hover:to-blue-600 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
            >
                ...
                <div key={item.name}>
                  ...
                  {item.name === 'Technology' && (
                    <div className="pl-6 space-y-1">
                      ...
                      <Link to="/web-design-development" onClick={() => setIsOpen(false)} className="block text-gray-600 hover:text-blue-600">Web Design & Development</Link>
                      <Link to="/application-development" onClick={() => setIsOpen(false)} className="block text-gray-600 hover:text-blue-600">Application Development</Link>
                      <Link to="/data-analytics-visualization" onClick={() => setIsOpen(false)} className="block text-gray-600 hover:text-blue-600">Data Analytics</Link>
                      <Link to="/automation-digital-transformation" onClick={() => setIsOpen(false)} className="block text-gray-600 hover:text-blue-600">Automation</Link>
                    </div>
                  )}
                  {item.name === 'Consulting' && (
                    <div className="pl-6 space-y-1">
